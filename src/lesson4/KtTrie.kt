...
class KtTrie : AbstractMutableSet<String>(), MutableSet<String> {
    ...
    inner class KtTrieIterator internal constructor() : MutableIterator<String> {
        ...
        // N - общее число узлов в дереве
        // while: худший случай: T(N) = O(N) - длина слова совпадает с высотой дерева.
        // Удалось обеспечить наилучшее быстродействие, за счет того, что каждый узел мы проходим 1 раз.
        // По итогу получается, что T(N) = M * O(N) = O(N) - где M - кол-во слов.
